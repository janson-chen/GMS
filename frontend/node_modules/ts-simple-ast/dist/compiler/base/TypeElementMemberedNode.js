    ...
    return /** @class */ (function (_super) {
        ...
        class_1.prototype.insertConstructSignatures = function (index, structures) {
            return insertChildren({
                ...
                createStructurePrinter: function (writer) { return new structurePrinters.ConstructSignatureDeclarationStructurePrinter(writer); }
            });
        };
        ...
        class_1.prototype.insertCallSignatures = function (index, structures) {
            return insertChildren({
                ...
                createStructurePrinter: function (writer) { return new structurePrinters.CallSignatureDeclarationStructurePrinter(writer); }
            });
        };
        ...
        class_1.prototype.insertIndexSignatures = function (index, structures) {
            return insertChildren({
                ...
                createStructurePrinter: function (writer) { return new structurePrinters.IndexSignatureDeclarationStructurePrinter(writer); }
            });
        };
        ...
        class_1.prototype.insertMethods = function (index, structures) {
            return insertChildren({
                ...
                createStructurePrinter: function (writer) { return new structurePrinters.MethodSignatureStructurePrinter(writer); }
            });
        };
        ...
        class_1.prototype.insertProperties = function (index, structures) {
            return insertChildren({
                ...
                createStructurePrinter: function (writer) { return new structurePrinters.PropertySignatureStructurePrinter(writer); }
            });
        };
