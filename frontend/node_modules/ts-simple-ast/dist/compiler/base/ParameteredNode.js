...
function ParameteredNode(Base) {
    return /** @class */ (function (_super) {
        ...
        class_1.prototype.insertParameters = function (index, structures) {
            ...
            var structurePrinter = new structurePrinters_1.CommaSeparatedStructuresPrinter(writer, new structurePrinters_1.ParameterDeclarationStructurePrinter(writer));
