...
var ClassDeclaration = /** @class */ (function (_super) {
    ...
    ClassDeclaration.prototype.insertConstructor = function (index, structure) {
        ...
        return manipulation_1.insertIntoBracesOrSourceFileWithGetChildren({
            ...
            write: function (writer, info) {
                ...
                new structurePrinters.ConstructorDeclarationStructurePrinter(writer, { isAmbient: isAmbient }).printText(structure);
        ...
        return manipulation_1.insertIntoBracesOrSourceFileWithGetChildren({
            ...
            write: function (writer, info) {
                if (info.previousMember != null)
                    ...
                    writer.newLineIfLastNot();
                new structurePrinters.GetAccessorDeclarationStructurePrinter(writer, { isAmbient: _this.isAmbient() }).printTexts(structures);
        ...
        return manipulation_1.insertIntoBracesOrSourceFileWithGetChildren({
            ...
            write: function (writer, info) {
                if (info.previousMember != null)
                    ...
                    writer.newLineIfLastNot();
                new structurePrinters.SetAccessorDeclarationStructurePrinter(writer, { isAmbient: _this.isAmbient() }).printTexts(structures);
                if (info.nextMember != null)
                    writer.blankLineIfLastNot();
                else
                    writer.newLineIfLastNot();
        ...
        return manipulation_1.insertIntoBracesOrSourceFileWithGetChildren({
            ...
            write: function (writer, info) {
                if (!isAmbient && info.previousMember != null)
                    ...
                    writer.newLineIfLastNot();
                new structurePrinters.MethodDeclarationStructurePrinter(writer, { isAmbient: isAmbient }).printTexts(structures);
                if (!isAmbient && info.nextMember != null)
                    writer.blankLineIfLastNot();
                else
                    writer.newLineIfLastNot();
    ...
    ClassDeclaration.prototype.getImmediateDerivedClasses = function () {
        ...
        if (nameNode == null)
            return classes;
        try {
            for (var _a = __values(nameNode.getDefinitionReferencingNodes()), _b = _a.next(); !_b.done; _b = _a.next()) {
                var node = _b.value;
