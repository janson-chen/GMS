    ...
    return /** @class */ (function (_super) {
            ...
            return this._insertChildren({
                ...
                write: function (writer, info) {
                    _this._standardWrite(writer, info, function () {
                        new structurePrinters.ClassDeclarationStructurePrinter(writer, { isAmbient: _this.sourceFile.isDeclarationFile() }).printTexts(structures);
                    });
                }
            });
        };
        ...
        class_1.prototype.insertNamespaces = function (index, structures) {
            ...
            return this._insertChildren({
                ...
                write: function (writer, info) {
                    _this._standardWrite(writer, info, function () {
                        new structurePrinters.NamespaceDeclarationStructurePrinter(writer, { isAmbient: _this.sourceFile.isDeclarationFile() }).printTexts(structures);
                    });
                }
            });
        };
