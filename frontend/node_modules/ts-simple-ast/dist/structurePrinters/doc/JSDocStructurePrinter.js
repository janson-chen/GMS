...
var JSDocStructurePrinter = /** @class */ (function (_super) {
    __extends(JSDocStructurePrinter, _super);
    function JSDocStructurePrinter() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    JSDocStructurePrinter.prototype.printText = function (structure) {
    ...
    JSDocStructurePrinter.prototype.printDocs = function (structures) {
        if (structures == null)
            return;
        try {
